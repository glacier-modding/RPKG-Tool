        ...
        if (hash_reference_data_size > 0)
        {
            ...
            for (rapidjson::SizeType i = 0; i < hash_reference_data.Size(); i++)
            {
                if (hash_reference_data[i]["flag"].IsNull())
                {
                    ...
                    response_string = "Error: hash_reference_data[" + std::to_string(i) + "][\"flag\"] is missing from the JSON.";
            ...
            for (rapidjson::SizeType i = 0; i < hash_reference_data.Size(); i++)
            {
                if (hash_reference_data[i]["hash"].IsNull())
                {
                    ...
                    response_string = "Error: hash_reference_data[" + std::to_string(i) + "][\"hash\"] is missing from the JSON.";
                ...
                if (hash_value_string.length() == 0)
                {
                    ...
                    response_string = "Error: hash_reference_data[" + std::to_string(i) + "][\"hash\"] is empty in the JSON.";
