...
public:
    ...
    static void extract_sdef_to_json(std::string& input_path, const std::string& filter, const std::string& output_path);
    ...
    static void extract_mati_to_json(std::string& input_path, const std::string& filter, const std::string& output_path);
    ...
    static void extract_all_hash_depends_from(std::string& input_path, std::string& unparsed_filters, std::string& output_path, HashExtractionStrategy strategy);
    ...
    static void extract_locr_to_json_from(std::string& input_path, std::string& output_path, bool output_to_string);
    ...
    static bool import_rpkg_meta(rpkg& rpkg_meta_data, const std::string& rpkg_meta_file_path, const std::string& input_rpkg_folder_path);
