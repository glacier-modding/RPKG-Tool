...
public:
	...
	static void dev_extract_all_strings(std::string &input_path, std::string &output_path);
	static void dev_extract_wwem_strings(std::string& output_path);
	static void dev_extract_wwes_strings(std::string& output_path);
	static void dev_extract_wwev_strings(std::string& output_path);
};
