...
void obj::output_to_multiple_files(asset3d asset3d_data, std::string& file_path)
{
    ...
    for (uint32_t v = 0; v < asset3d_data.vertexes->size(); v++)
    {
        ...
        obj_file_data.append(util::float_to_string(asset3d_data.vertexes->at(v).x));
        obj_file_data.push_back(' ');
        obj_file_data.append(util::float_to_string(asset3d_data.vertexes->at(v).y));
        obj_file_data.push_back(' ');
        obj_file_data.append(util::float_to_string(asset3d_data.vertexes->at(v).z));
        //obj_file_data.push_back(' ');
    ...
    for (uint32_t v = 0; v < asset3d_data.normals->size(); v++)
    {
        ...
        obj_file_data.append(util::float_to_string(asset3d_data.normals->at(v).x));
        obj_file_data.push_back(' ');
        obj_file_data.append(util::float_to_string(asset3d_data.normals->at(v).y));
        obj_file_data.push_back(' ');
        obj_file_data.append(util::float_to_string(asset3d_data.normals->at(v).z));
        //obj_file_data.push_back(' ');
        //obj_file_data.append(util::float_to_string(asset3d_data.normals->at(v).w));
        obj_file_data.push_back('\n');
    }

    for (uint32_t v = 0; v < asset3d_data.uvs->size(); v++)
    {
        obj_file_data.append("vt ");
        obj_file_data.append(util::float_to_string(asset3d_data.uvs->at(v).x));
        obj_file_data.push_back(' ');
        obj_file_data.append(util::float_to_string(asset3d_data.uvs->at(v).y));
        obj_file_data.push_back('\n');
    }

    for (uint32_t v = 0; v < (asset3d_data.indexes->size() / 3); v++)
    {
        uint32_t one = asset3d_data.indexes->at((uint64_t)v * (uint64_t)3);
        one++;
        uint32_t two = asset3d_data.indexes->at((uint64_t)v * (uint64_t)3 + (uint64_t)1);
        two++;
        uint32_t three = asset3d_data.indexes->at((uint64_t)v * (uint64_t)3 + (uint64_t)2);
        three++;
