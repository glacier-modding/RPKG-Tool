...
{
    [ResourceAction("TEXT", "Convert linked TEXTs(TEXDs) to TGA File(s)")]
    public class ConvertTgaAction : IAction
    {
        public void Perform(string rpkgPath, string resourceHash)
        {
            ...
            progress.message.Content = "Extracting " + resourceHash + " To TGA File(s)...";

            MainWindow.ExtractTEXT("-extract_text_from", rpkgPath, resourceHash, "", "", outputFolder);
