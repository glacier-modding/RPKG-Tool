...
namespace rpkg.Resources.LOCR.Actions
{
    [ResourceAction("LOCR", "Convert to JSON (IOI Path)")]
    public class ConvertJsonAction : IAction
    {
        public void Perform(string rpkgPath, string resourceHash)
        {
            ...
            RpkgLib.task_execute("-extract_locr_to_json_from", rpkgPath, resourceHash, "", "", outputFolder);
