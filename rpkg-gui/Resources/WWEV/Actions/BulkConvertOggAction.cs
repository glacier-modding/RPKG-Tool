...
namespace rpkg.Resources.WWEV.Actions
{
    [BulkResourceAction("WWEV", "Convert All To OGG To IOI Paths")]
    public class BulkConvertOggAction : IBulkAction
    {
        public void PerformBulk(string rpkgPath, string resourceType)
        {
            ...
            RpkgLib.task_execute("-extract_wwev_to_ogg_from", rpkgPath, resourceType, "", "", outputFolder);
