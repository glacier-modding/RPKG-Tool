...
namespace rpkg.Resources.RTLV.Actions
{
    [ResourceAction("RTLV", "Convert to JSON (IOI Path)")]
    public class ConvertJsonAction : IAction
    {
        public void Perform(string rpkgPath, string resourceHash)
        {
            ...
            RpkgLib.task_execute("-extract_rtlv_to_json_from", rpkgPath, resourceHash, "", "", outputFolder);
