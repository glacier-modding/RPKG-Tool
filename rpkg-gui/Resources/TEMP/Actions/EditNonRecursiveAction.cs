...
{
    [ResourceAction("TEMP", "Edit in Brick/Entity Editor (Non-Recursive)")]
    public class EditNonRecursiveAction : IAction
    {
        public void Perform(string rpkgPath, string resourceHash)
        {
            string rpkgFileBackup = rpkgPath;
            ...
            RpkgLib.load_non_recursive_temps(resourceHash, rpkgPath, (uint) temp_file_version);
