...
namespace rpkg
{
    ...
    public partial class Progress : MetroWindow
    {
        ...
        void worker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            if (operation != (int)Operation.IMPORT)
            {
                message.Content = "Performing requested actions (this may take a moment!)";
            }
        }
        ...
        [DllImport("rpkg-lib.dll", EntryPoint = "reset_task_single_status", CallingConvention = CallingConvention.Cdecl)]
        public static extern int reset_task_single_status();

        [DllImport("rpkg-lib.dll", EntryPoint = "get_task_multiple_status", CallingConvention = CallingConvention.Cdecl)]
        public static extern int get_task_multiple_status();

        [DllImport("rpkg-lib.dll", EntryPoint = "reset_task_multiple_status", CallingConvention = CallingConvention.Cdecl)]
